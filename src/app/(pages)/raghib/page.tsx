...
const page = () => {
  return (
    <>
    <div className='bg-gradient-to-r from-cyan-400 via-green-200 to-blue-300 flex items-center justify-center h-screen'>
      ...
      <div className='bg-white bg-blur-sm bg-opacity-75 p-6 rounded-2xl shadow-[0px_-4px_0px_12px_rgba(255,_255,_255,_0.5)] w-96 flex gap-x-5 '>
        ...
        <div>
          ...
          <button className='bg-black text-white px-4 py-1 rounded border-solid border border-black flex items-center hover:bg-transparent hover:text-black'>Follow</button>
            <button className='bg-transparent border-solid border border-black text-black px-4 py-1 rounded flex items-center hover:bg-blue-300 hover:scale-110 transition-transform hover:text-white hover:border-white '>View Profile</button>
          </div>
